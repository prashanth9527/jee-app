...
-- CreateEnum
CREATE TYPE "public"."ProcessingStatus" AS ENUM ('PENDING', 'UPLOADING', 'PROCESSING', 'COMPLETED', 'FAILED', 'RETRYING');

-- CreateEnum
CREATE TYPE "public"."LogType" AS ENUM ('INFO', 'WARNING', 'ERROR', 'SUCCESS', 'API_CALL', 'FILE_UPLOAD', 'FILE_PROCESSING', 'VALIDATION');
...
CREATE TABLE "public"."Question" (
    ...
    "topicId" TEXT,
    "subtopicId" TEXT,
    "status" "public"."QuestionStatus" NOT NULL DEFAULT 'underreview',
    "pdfProcessorCacheId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "createdById" TEXT,
...
CREATE TABLE "public"."system_settings" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "logoFooter" TEXT,
    "hometemplate" VARCHAR(255) DEFAULT 'default',
...
-- CreateTable
CREATE TABLE "public"."pdf_processor_cache" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "pdf_processor_cache_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "public"."pdf_processor_logs" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "pdf_processor_logs_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "pdf_processor_cache_fileName_key" ON "public"."pdf_processor_cache"("fileName");
...
-- AddForeignKey
ALTER TABLE "public"."Question" ADD CONSTRAINT "Question_pdfProcessorCacheId_fkey" FOREIGN KEY ("pdfProcessorCacheId") REFERENCES "public"."pdf_processor_cache"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."pdf_processor_logs" ADD CONSTRAINT "pdf_processor_logs_cacheId_fkey" FOREIGN KEY ("cacheId") REFERENCES "public"."pdf_processor_cache"("id") ON DELETE CASCADE ON UPDATE CASCADE;
