...
/**
 * Seed file for JEE Mathematics Paper - 2301-Mathematics Paper With Sol. Morning
 * Source: content/JEE/Previous Papers/2025/Session1/Maths/2301-Mathematics Paper+With+Sol. Morning.pdf
 * 
...
export async function seed2301MathematicsPaperWithSolMorning() {
  console.log('🧮 Starting 2301-Mathematics Paper With Sol. Morning Paper seeding...');
  ...
  // TODO: Add questions from 2301-Mathematics Paper+With+Sol. Morning.pdf
  console.log('⚠️  2301-Mathematics Paper With Sol. Morning Paper questions not yet implemented');
  console.log('📄 Please extract questions from: 2301-Mathematics Paper+With+Sol. Morning.pdf');
  ...
  if (questionsData.length > 0) {
    ...
    console.log(`🎉 Successfully seeded ${questionsData.length} mathematics questions from 2301-Mathematics Paper With Sol. Morning Paper`);
  } else {
    console.log('📝 No questions to seed - PDF content extraction pending');
  }
}

export default seed2301MathematicsPaperWithSolMorning;