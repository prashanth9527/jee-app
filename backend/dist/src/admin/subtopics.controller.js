...
exports.AdminSubtopicsController = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
const jwt_guard_1 = require("../auth/jwt.guard");
const roles_guard_1 = require("../auth/roles.guard");
const roles_decorator_1 = require("../auth/roles.decorator");
let AdminSubtopicsController = class AdminSubtopicsController {
    constructor(prisma) {
        this.prisma = prisma;
    }
    list(topicId) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AdminSubtopicsController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    ...
    __metadata("design:returntype", void 0)
], AdminSubtopicsController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AdminSubtopicsController.prototype, "remove", null);
exports.AdminSubtopicsController = AdminSubtopicsController = __decorate([
    (0, common_1.Controller)('admin/subtopics'),
