...
export default function ExpertLayout({ children }: ExpertLayoutProps) {
  ...
  return (
    <>
      ...
      <DynamicHead 
        title={`Expert Panel - ${systemSettings?.siteTitle || 'JEE App'}`}
        description={`Expert panel for ${systemSettings?.siteDescription || 'JEE preparation platform'}`}
        keywords={`expert panel, ${systemSettings?.siteKeywords || 'JEE, preparation, practice tests'}, JEE expert, education expert, question creation`}
        canonicalUrl={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://jeemaster.com'}/expert`}
        ogImage={systemSettings?.ogImageUrl ? `${process.env.NEXT_PUBLIC_SITE_URL || 'https://jeemaster.com'}${systemSettings.ogImageUrl}` : `${process.env.NEXT_PUBLIC_SITE_URL || 'https://jeemaster.com'}/og-expert.jpg`}
        structuredData={{
          "@context": "https://schema.org",
          "@type": "EducationalOrganization",
          "name": systemSettings?.siteTitle || 'JEE App',
          "description": `Expert panel for ${systemSettings?.siteDescription || 'JEE preparation platform'}`,
          "url": `${process.env.NEXT_PUBLIC_SITE_URL || 'https://jeemaster.com'}/expert`,
