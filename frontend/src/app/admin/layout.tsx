...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  useEffect(() => {
    if (systemSettings?.siteDescription) {
      ...
      metaDescription.setAttribute('content', `Admin panel for ${systemSettings.siteDescription}`);
    }
  ...
  useEffect(() => {
    if (systemSettings?.siteKeywords) {
      ...
      metaKeywords.setAttribute('content', `admin panel, ${systemSettings.siteKeywords}, JEE admin, education management`);
    }
  ...
  useEffect(() => {
    if (systemSettings) {
      ...
      updateMetaTag('og:description', `Admin panel for ${systemSettings.siteDescription}`);
      ...
      updateMetaName('twitter:description', `Admin panel for ${systemSettings.siteDescription}`);
      ...
      // Add structured data for educational organization with admin context
      const structuredData = {
        "@context": "https://schema.org",
        "@type": "EducationalOrganization",
        "name": systemSettings.siteTitle,
        "description": `Admin panel for ${systemSettings.siteDescription}`,
