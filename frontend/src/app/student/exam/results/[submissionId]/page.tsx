  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-4xl mx-4 shadow-xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray">Marks & Score Calculation Guide</h3>
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-100"
          >
        ...
        <div className="space-y-6">
          {/* Overview */}
          <div className="bg-gray-800 dark:bg-gray-800 rounded-lg p-4 border-2 border-gray-300 dark:border-gray-400">
            <h4 className="text-lg font-semibold text-gray-100 mb-2">📊 Your Current Results</h4>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div>
                <span className="text-gray-300">Score:</span>
                <span className="font-bold ml-2 text-gray-100">{results.scorePercent}%</span>
              </div>
              <div>
                <span className="text-gray-300">Marks:</span>
                <span className="font-bold ml-2 text-gray-100">{results.totalMarksObtained}/{results.totalMarksAvailable}</span>
              </div>
              <div>
                <span className="text-gray-300">Correct:</span>
                <span className="font-bold ml-2 text-gray-100">{results.correctCount}/{results.totalQuestions}</span>
              </div>
              <div>
                <span className="text-gray-300">Marks %:</span>
                <span className="font-bold ml-2 text-gray-100">{Math.round((results.totalMarksObtained / results.totalMarksAvailable) * 100)}%</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 dark:bg-gray-800 rounded-lg p-4 border-2 border-gray-300 dark:border-gray-400">
            <h4 className="text-lg font-semibold text-gray-100 mb-3">🎯 Score vs Marks - What's the Difference?</h4>
            <div className="space-y-3 text-sm text-gray-200">
              <div>
                <strong className="text-gray-100">Score Percentage:</strong> Based on number of correct answers
                <br />
                <code className="bg-gray-700 dark:bg-gray-900 text-gray-200 px-2 py-1 rounded">Score = (Correct Answers ÷ Total Questions) × 100</code>
                <br />
                <span className="text-xs text-gray-400">Example: 5 correct out of 25 = (5÷25) × 100 = 20%</span>
              </div>
              <div>
                <strong className="text-gray-100">Marks:</strong> Based on marking scheme (includes negative marking)
                <br />
                <code className="bg-gray-700 dark:bg-gray-900 text-gray-200 px-2 py-1 rounded">Total Marks = Sum of all question marks (positive + negative)</code>
                <br />
                <span className="text-xs text-gray-400">Example: 5 correct (+20) + 20 wrong (-20) = 0 marks</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray">📝 Marking Schemes by Question Type</h4>
            
            {/* MCQ Single */}
            <div className="bg-gray-800 dark:bg-gray-800 rounded-lg p-4 border-2 border-gray-300 dark:border-gray-400">
              <h5 className="font-semibold text-gray-100 mb-2">🔘 MCQ Single Choice</h5>
              <div className="text-sm text-gray-200 space-y-1">
                <div>✅ <strong className="text-gray-100">Correct Answer:</strong> +4 marks</div>
                <div>❌ <strong className="text-gray-100">Wrong Answer:</strong> -1 mark</div>
                <div>⭕ <strong className="text-gray-100">Not Attempted:</strong> 0 marks</div>
                <div className="text-xs mt-2 bg-gray-700 dark:bg-gray-900 text-gray-200 p-2 rounded">
            ...
            {/* Open Ended */}
            <div className="bg-gray-800 dark:bg-gray-800 rounded-lg p-4 border-2 border-gray-300 dark:border-gray-400">
              <h5 className="font-semibold text-gray-100 mb-2">✏️ Open Ended Questions</h5>
              <div className="text-sm text-gray-200 space-y-1">
                <div>✅ <strong className="text-gray-100">Correct Answer:</strong> +4 marks</div>
                <div>❌ <strong className="text-gray-100">Wrong Answer:</strong> -1 mark</div>
                <div>⭕ <strong className="text-gray-100">Not Attempted:</strong> 0 marks</div>
            ...
            {/* Paragraph */}
            <div className="bg-gray-800 dark:bg-gray-800 rounded-lg p-4 border-2 border-gray-300 dark:border-gray-400">
              <h5 className="font-semibold text-gray-100 mb-2">📄 Paragraph Questions</h5>
              <div className="text-sm text-gray-200 space-y-1">
                <div>✅ <strong className="text-gray-100">Correct Answer:</strong> +2 marks</div>
                <div>❌ <strong className="text-gray-100">Wrong Answer:</strong> 0 marks</div>
                <div>⭕ <strong className="text-gray-100">Not Attempted:</strong> 0 marks</div>
                <div className="text-xs mt-2 bg-gray-700 dark:bg-gray-900 text-gray-200 p-2 rounded">
            ...
            {/* MCQ Multiple */}
            <div className="bg-gray-800 dark:bg-gray-800 rounded-lg p-4 border-2 border-gray-300 dark:border-gray-400">
              <h5 className="font-semibold text-gray-100 mb-2">☑️ MCQ Multiple Choice</h5>
              <div className="text-sm text-gray-200 space-y-1">
                <div>✅ <strong className="text-gray-100">All Correct Options:</strong> +4 marks</div>
                <div>🟡 <strong className="text-gray-100">3 out of 4 Correct:</strong> +3 marks</div>
                <div>🟡 <strong className="text-gray-100">2 out of 3+ Correct:</strong> +2 marks</div>
                <div>🟡 <strong className="text-gray-100">1 out of 2+ Correct:</strong> +1 mark</div>
                <div>❌ <strong className="text-gray-100">Any Wrong Selection:</strong> -2 marks</div>
                <div>⭕ <strong className="text-gray-100">Not Attempted:</strong> 0 marks</div>
                <div className="text-xs mt-2 bg-gray-700 dark:bg-gray-900 text-gray-200 p-2 rounded">
          ...
          {/* Tips */}
          <div className="bg-gray-800 dark:bg-gray-800 rounded-lg p-4 border-2 border-gray-300 dark:border-gray-400">
            <h4 className="text-lg font-semibold text-gray-100 mb-3">💡 Tips for Better Performance</h4>
            <div className="text-sm text-gray-200 space-y-2">
              <div>• <strong className="text-gray-100">Don't guess randomly:</strong> Negative marking means wrong answers cost you marks</div>
              <div>• <strong className="text-gray-100">Attempt questions you're confident about:</strong> Correct answers give you full marks</div>
              <div>• <strong className="text-gray-100">For MCQ Multiple:</strong> Only select options you're sure about to avoid negative marking</div>
              <div>• <strong className="text-gray-100">Time management:</strong> Focus on questions you can solve rather than attempting all</div>
            </div>
          </div>
        </div>
